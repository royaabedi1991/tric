...
public class SaveFragmentAdapter extends RecyclerView.Adapter<SaveFragmentAdapter.Holder> {
    private LayoutInflater inflater;
    List<com.a3rick.a3rick.models.models.Trick.favorites.Result> results;


    public SaveFragmentAdapter(Context context, List<Result> results) {
    ...
    @NonNull
    @Override
    public SaveFragmentAdapter.Holder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull SaveFragmentAdapter.Holder holder, final int position) {
