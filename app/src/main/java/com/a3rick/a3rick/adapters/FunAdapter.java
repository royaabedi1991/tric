...
public class FunAdapter extends RecyclerView.Adapter<FunAdapter.Holder> {
    ...
    public FunAdapter(Context context, List<Result_> result_s) {
    ...
    public FunAdapter.Holder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        Holder holder = new Holder(inflater.inflate(R.layout.row_fun, parent, false));
    ...
    @Override
    public void onBindViewHolder(@NonNull FunAdapter.Holder holder, final int position) {
    ...
    public class Holder extends RecyclerView.ViewHolder {
        ...
        public Holder(View itemView) {
            ...
            textView = itemView.findViewById(R.id.tvFun);
        }


        private void getContents() {
            FileApi fileApi = RetrofitClient.getRetroClient().create(FileApi.class);
            Call<GetContentResult> call = fileApi.getContent(/*"{{Token}}",*/13, 1, 20, "LastItem");
