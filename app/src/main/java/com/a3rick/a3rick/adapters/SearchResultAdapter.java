...
public class SearchResultAdapter extends RecyclerView.Adapter<SearchResultAdapter.Holder> implements Serializable {
    private LayoutInflater inflater;
    List<Result> result_s;
    RecyclerViewClicked recyclerViewClicked;
    ChangeCategoryItem changeCategoryItem;

    public SearchResultAdapter(Context context, List<Result> result_s, RecyclerViewClicked recyclerViewClicked, ChangeCategoryItem changeCategoryItem) {
    ...
    @NonNull
    @Override
    public SearchResultAdapter.Holder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        Holder holder = new Holder(inflater.inflate(R.layout.row_search_result, parent, false));
...
//        notifyDataSetChanged();
    ...
    @Override
    public void onBindViewHolder(@NonNull SearchResultAdapter.Holder holder, final int position) {
    ...
    public class Holder extends RecyclerView.ViewHolder {
        ...
        public Holder(View itemView) {
            super(itemView);
            imageView = itemView.findViewById(R.id.tv_headerImage_sarch_result);
            textView = itemView.findViewById(R.id.tv_subject_sarch_result);
